...
// Credenciais extraídas da sua string de conexão:
// postgresql://studyflix_user:C7RDk7jynwGOQqr78NGhBDB7a2QCapvo@dpg-d47ph0k9c44c73cbi1dg-a.oregon-postgres.render.com/studyflix_db_qurq
...
function getDbConnection() {
    // DSN (string de conexão) para PostgreSQL, incluindo sslmode=require (obrigatório no Render)
